...
module saclient.cloud.resource {
	...
	import Iface = saclient.cloud.resource.Iface;
	import ServerPlan = saclient.cloud.resource.ServerPlan;
	import ServerInstance = saclient.cloud.resource.ServerInstance;
	 ...
	 * @extends Resource
	 */
	export class Server extends saclient.cloud.resource.Resource {
