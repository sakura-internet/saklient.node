...
class Appliance extends Resource {
	 ...
	 * ID
	 * 
	 * @member saklient.cloud.resource.Appliance#m_id
	 * @type string
	 * @protected
	 */
	m_id : string;
	 ...
	 * 名前
	 * 
	 * @member saklient.cloud.resource.Appliance#m_name
	 * @type string
	 * @protected
	 */
	m_name : string;
	 ...
	 * 説明
	 * 
	 * @member saklient.cloud.resource.Appliance#m_description
	 * @type string
	 * @protected
	 */
	 ...
	 * タグ
	 * 
	 * @member saklient.cloud.resource.Appliance#m_tags
	 * @type string[]
	 * @protected
	 */
	m_tags : string[];
	 ...
	 * アイコン
	 * 
	 * @member saklient.cloud.resource.Appliance#m_icon
	 * @type Icon
	 * @protected
	 */
	m_icon : Icon;
	 ...
	 * プラン
	 * 
	 * @member saklient.cloud.resource.Appliance#m_ifaces
	 * @type Iface[]
	 * @protected
	 */
	m_ifaces : Iface[];
	 ...
	 * サービスクラス
	 * 
	 * @member saklient.cloud.resource.Appliance#m_serviceClass
	 * @type string
	 * @protected
	 */
	...
	private set_clazz(v:string) : string {
		...
		if (!this.isNew) {
			throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resource.Appliance#clazz");
		};
		this.m_clazz = v;
		this.n_clazz = true;
		return this.m_clazz;
