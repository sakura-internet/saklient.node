...
class Router extends Resource {
	 ...
	 * ID
	 * 
	 * @member saklient.cloud.resource.Router#m_id
	 * @type string
	 * @protected
	 */
	m_id : string;
	 ...
	 * 名前
	 * 
	 * @member saklient.cloud.resource.Router#m_name
	 * @type string
	 * @protected
	 */
	m_name : string;
	 ...
	 * 説明
	 * 
	 * @member saklient.cloud.resource.Router#m_description
	 * @type string
	 * @protected
	 */
	 ...
	 * ネットワークのマスク長
	 * 
	 * @member saklient.cloud.resource.Router#m_networkMaskLen
	 * @type number
	 * @protected
	 */
	 ...
	 * 帯域幅
	 * 
	 * @member saklient.cloud.resource.Router#m_bandWidthMbps
	 * @type number
	 * @protected
	 */
	 ...
	 * スイッチ
	 * 
	 * @member saklient.cloud.resource.Router#m_swytchId
	 * @type string
	 * @protected
	 */
	m_swytchId : string;
	 ...
	 */
	getSwytch() : Swytch {
		var model:any = Util.createClassInstance("saklient.cloud.model.Model_Swytch", [this._client]);
	...
	removeIpv6Net(ipv6Net:Ipv6Net) : Router {
		...
		Util.validateType(ipv6Net, "saklient.cloud.resource.Ipv6Net");
	...
	private set_networkMaskLen(v:number) : number {
		...
		if (!this.isNew) {
			throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resource.Router#networkMaskLen");
		};
	...
	private set_bandWidthMbps(v:number) : number {
		...
		Util.validateType(v, "number");
		if (!this.isNew) {
			throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resource.Router#bandWidthMbps");
		};
