...
class Archive extends Resource {
	 ...
	 * ID
	 * 
	 * @member saklient.cloud.resource.Archive#m_id
	 * @type string
	 * @protected
	 */
	m_id : string;
	 ...
	 * 名前
	 * 
	 * @member saklient.cloud.resource.Archive#m_name
	 * @type string
	 * @protected
	 */
	m_name : string;
	 ...
	 * 説明
	 * 
	 * @member saklient.cloud.resource.Archive#m_description
	 * @type string
	 * @protected
	 */
	 ...
	 * タグ
	 * 
	 * @member saklient.cloud.resource.Archive#m_tags
	 * @type string[]
	 * @protected
	 */
	m_tags : string[];
	 ...
	 * アイコン
	 * 
	 * @member saklient.cloud.resource.Archive#m_icon
	 * @type Icon
	 * @protected
	 */
	m_icon : Icon;
	 ...
	 * 表示順序
	 * 
	 * @member saklient.cloud.resource.Archive#m_displayOrder
	 * @type number
	 * @protected
	 */
	 ...
	 * サイズ[MiB]
	 * 
	 * @member saklient.cloud.resource.Archive#m_sizeMib
	 * @type number
	 * @protected
	 */
	m_sizeMib : number;
	 ...
	 * サービスクラス
	 * 
	 * @member saklient.cloud.resource.Archive#m_serviceClass
	 * @type string
	 * @protected
	 */
	 ...
	 * プラン
	 * 
	 * @member saklient.cloud.resource.Archive#m_plan
	 * @type DiskPlan
	 * @protected
	 */
	m_plan : DiskPlan;
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.Archive#_source
	 * @type Resource
	 */
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.Archive#_ftpInfo
	 * @type FtpInfo
	 * @protected
	 */
	_ftpInfo : FtpInfo;
		...
		if (r != null) {
			...
			if (("SourceDisk" in r)) {
				...
				if (s != null) {
					var id:any = s["ID"];
					if (id != null) {
						var obj:any = Util.createClassInstance("saklient.cloud.resource.Disk", [this._client, s]);
	...
	/**
	 * @member saklient.cloud.resource.Archive#n_displayOrder
	 * @default false
	 * @type boolean
	 * @private
	 */
