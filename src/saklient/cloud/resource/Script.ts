...
import EScriptClass = require('../enums/EScriptClass');
...
class Script extends Resource {
	 ...
	 * ID
	 * 
	 * @member saklient.cloud.resource.Script#m_id
	 * @type string
	 * @protected
	 */
	m_id : string;
	 ...
	 * 名前
	 * 
	 * @member saklient.cloud.resource.Script#m_name
	 * @type string
	 * @protected
	 */
	m_name : string;
	 ...
	 * 説明
	 * 
	 * @member saklient.cloud.resource.Script#m_description
	 * @type string
	 * @protected
	 */
	 ...
	 * タグ
	 * 
	 * @member saklient.cloud.resource.Script#m_tags
	 * @type string[]
	 * @protected
	 */
	m_tags : string[];
	 ...
	 * アイコン
	 * 
	 * @member saklient.cloud.resource.Script#m_icon
	 * @type Icon
	 * @protected
	 */
	m_icon : Icon;
	 ...
	 * 内容
	 * 
	 * @member saklient.cloud.resource.Script#m_content
	 * @type string
	 * @protected
	 */
	m_content : string;
	 ...
	 * 注釈
	 * 
	 * @member saklient.cloud.resource.Script#m_annotation
	 * @type any
	 * @protected
	 */
	m_annotation : any;
