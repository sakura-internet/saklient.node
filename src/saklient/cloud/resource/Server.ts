...
class Server extends Resource {
	 ...
	 * ID
	 * 
	 * @member saklient.cloud.resource.Server#m_id
	 * @type string
	 * @protected
	 */
	m_id : string;
	 ...
	 * 名前
	 * 
	 * @member saklient.cloud.resource.Server#m_name
	 * @type string
	 * @protected
	 */
	m_name : string;
	 ...
	 * 説明
	 * 
	 * @member saklient.cloud.resource.Server#m_description
	 * @type string
	 * @protected
	 */
	 ...
	 * タグ
	 * 
	 * @member saklient.cloud.resource.Server#m_tags
	 * @type string[]
	 * @protected
	 */
	m_tags : string[];
	 ...
	 * アイコン
	 * 
	 * @member saklient.cloud.resource.Server#m_icon
	 * @type Icon
	 * @protected
	 */
	m_icon : Icon;
	 ...
	 * プラン
	 * 
	 * @member saklient.cloud.resource.Server#m_plan
	 * @type ServerPlan
	 * @protected
	 */
	m_plan : ServerPlan;
	 ...
	 * インタフェース
	 * 
	 * @member saklient.cloud.resource.Server#m_ifaces
	 * @type Iface[]
	 * @protected
	 */
	m_ifaces : Iface[];
	 ...
	 * インスタンス情報
	 * 
	 * @member saklient.cloud.resource.Server#m_instance
	 * @type ServerInstance
	 * @protected
	 */
	 ...
	 */
	findDisks() : Disk[] {
		var model:any = Util.createClassInstance("saklient.cloud.model.Model_Disk", [this._client]);
	 ...
	 */
	addIface() : Iface {
		var model:any = Util.createClassInstance("saklient.cloud.model.Model_Iface", [this._client]);
