...
class DiskConfig {
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.DiskConfig#_client
	 * @type Client
	 * @protected
	 */
	_client : Client;
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.DiskConfig#_diskId
	 * @type string
	 * @protected
	 */
	_diskId : string;
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.DiskConfig#_hostName
	 * @type string
	 * @protected
	 */
	_hostName : string;
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.DiskConfig#_password
	 * @type string
	 * @protected
	 */
	_password : string;
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.DiskConfig#_sshKey
	 * @type string
	 * @protected
	 */
	_sshKey : string;
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.DiskConfig#_ipAddress
	 * @type string
	 * @protected
	 */
	_ipAddress : string;
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.DiskConfig#_defaultRoute
	 * @type string
	 * @protected
	 */
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.DiskConfig#_networkMaskLen
	 * @type number
	 * @protected
	 */
	...
	/**
	 * @private
	 * @member saklient.cloud.resource.DiskConfig#_scripts
	 * @type Script[]
	 * @protected
	 */
	_scripts : Script[];
