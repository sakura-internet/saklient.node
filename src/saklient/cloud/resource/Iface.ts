...
class Iface extends Resource {
	 ...
	 * ID
	 * 
	 * @member saklient.cloud.resource.Iface#m_id
	 * @type string
	 * @protected
	 */
	m_id : string;
	 ...
	 * MACアドレス
	 * 
	 * @member saklient.cloud.resource.Iface#m_macAddress
	 * @type string
	 * @protected
	 */
	m_macAddress : string;
	 ...
	 * 
	 * @member saklient.cloud.resource.Iface#m_ipAddress
	 * @type string
	 * @protected
	 */
	m_ipAddress : string;
	 ...
	 * ユーザ設定IPv4アドレス
	 * 
	 * @member saklient.cloud.resource.Iface#m_userIpAddress
	 * @type string
	 * @protected
	 */
	 ...
	 * 
	 * @member saklient.cloud.resource.Iface#m_serverId
	 * @type string
	 * @protected
	 */
	m_serverId : string;
