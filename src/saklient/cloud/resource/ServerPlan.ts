...
class ServerPlan extends Resource {
	 ...
	 * ID
	 * 
	 * @member saklient.cloud.resource.ServerPlan#m_id
	 * @type string
	 * @protected
	 */
	m_id : string;
	 ...
	 * 名前
	 * 
	 * @member saklient.cloud.resource.ServerPlan#m_name
	 * @type string
	 * @protected
	 */
	m_name : string;
	 ...
	 * 仮想コア数
	 * 
	 * @member saklient.cloud.resource.ServerPlan#m_cpu
	 * @type number
	 * @protected
	 */
	m_cpu : number;
	 ...
	 * メモリ容量[MiB]
	 * 
	 * @member saklient.cloud.resource.ServerPlan#m_memoryMib
	 * @type number
	 * @protected
	 */
	m_memoryMib : number;
	 ...
	 * サービスクラス
	 * 
	 * @member saklient.cloud.resource.ServerPlan#m_serviceClass
	 * @type string
	 * @protected
	 */
