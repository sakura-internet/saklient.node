...
var Disk = (function (_super) {
    ...
    * @return {string}
    */
    Disk.prototype.className = function () {
        return "Disk";
    };
        ...
        if (r != null) {
            ...
            if (("SourceArchive" in r)) {
                ...
                if (s != null) {
                    var id = s["ID"];
                    if (id != null) {
                        var obj = Util.createClassInstance("saclient.cloud.resource.Archive", [this._client, s]);
                        this._source = (obj);
                    }
                    ;
                }
    ...
    */
    Disk.prototype.apiSerializeImpl = function (withClean) {
        ...
        ;
        if (missing.length > 0) {
            throw new SaclientException("required_field", "Required fields must be set before the Disk creation: " + missing.join(", "));
        }
        ;
        return ret;
    };
