...
var Archive = (function (_super) {
    ...
    * @return {string}
    */
    Archive.prototype.className = function () {
        return "Archive";
    };
        ...
        if (r != null) {
            ...
            if (("SourceDisk" in r)) {
                ...
                if (s != null) {
                    var id = s["ID"];
                    if (id != null) {
                        var obj = Util.createClassInstance("saclient.cloud.resource.Disk", [this._client, s]);
                        this._source = (obj);
                    }
                    ;
                }
    ...
    * @return {Archive}
    */
    Archive.prototype.closeFtp = function (reset) {
        if (typeof reset === "undefined") { reset = false; }
        Util.validateType(reset, "boolean");
        var path = this._apiPath() + "/" + Util.urlEncode(this._id()) + "/ftp";
