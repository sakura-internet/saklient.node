...
var Server = (function (_super) {
    ...
    * @return {void}
    */
    Server.prototype.afterUp = function (callback, timeout) {
    ...
    * @return {void}
    */
    Server.prototype.afterDown = function (callback, timeout) {
        if (typeof timeout === "undefined") { timeout = 60; }
    ...
    * @return {void}
    */
    Server.prototype.afterStatus = function (status, callback, timeout) {
        if (typeof timeout === "undefined") { timeout = 60; }
    ...
    * @return {boolean}
    */
    Server.prototype.sleepUntilUp = function (timeout) {
        if (typeof timeout === "undefined") { timeout = 60; }
    ...
    * @return {boolean}
    */
    Server.prototype.sleepUntilDown = function (timeout) {
        if (typeof timeout === "undefined") { timeout = 60; }
    ...
    * @return {boolean}
    */
    Server.prototype.sleepUntil = function (status, timeout) {
        if (typeof timeout === "undefined") { timeout = 60; }
        var step = 3;
        while (0 < timeout) {
            this.reload();
