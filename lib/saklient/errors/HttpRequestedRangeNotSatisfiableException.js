...
var HttpRequestedRangeNotSatisfiableException = (function (_super) {
    ...
    */
    function HttpRequestedRangeNotSatisfiableException(status, code, message) {
        if (typeof code === "undefined") { code = null; }
        if (typeof message === "undefined") { message = ""; }
        _super.call(this, status, code, message == null || message == "" ? "HTTPエラー。Requested Range Not Satisfiable." : message);
    }
