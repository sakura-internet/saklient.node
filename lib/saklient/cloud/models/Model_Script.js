...
var Script = require('../resources/Script');
...
var Model_Script = (function (_super) {
    ...
    * @return {Resource}
    */
    Model_Script.prototype._createResourceImpl = function (obj, wrapped) {
    ...
    * @return {Model_Script}
    */
    Model_Script.prototype.withTagDnf = function (dnf) {
        Util.validateArgCount(arguments.length, 1);
