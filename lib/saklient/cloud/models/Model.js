...
var Model = (function () {
    ...
    */
    Model.prototype._getById = function (id) {
        ...
        this._total = 1;
        this._count = 1;
        return (Util.createClassInstance("saklient.cloud.resources." + this._className(), [this._client, result, true]));
    };
    ...
    */
    Model.prototype._findOne = function () {
        ...
        ;
        var records = (result[this._rootKeyM()]);
        return (Util.createClassInstance("saklient.cloud.resources." + this._className(), [this._client, records[0]]));
    };
