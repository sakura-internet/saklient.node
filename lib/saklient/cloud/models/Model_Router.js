...
var Model_Router = (function (_super) {
    ...
    * @return {Resource}
    */
    Model_Router.prototype._createResourceImpl = function (obj, wrapped) {
    ...
    * @return {Model_Router}
    */
    Model_Router.prototype.withTag = function (tag) {
        Util.validateArgCount(arguments.length, 1);
    ...
    * @return {Model_Router}
    */
    Model_Router.prototype.withTags = function (tags) {
        Util.validateArgCount(arguments.length, 1);
    ...
    * @return {Model_Router}
    */
    Model_Router.prototype.withTagDnf = function (dnf) {
        Util.validateArgCount(arguments.length, 1);
