...
var Swytch = require('../resources/Swytch');
...
var Model_Swytch = (function (_super) {
    ...
    * @return {Resource}
    */
    Model_Swytch.prototype._createResourceImpl = function (obj, wrapped) {
    ...
    * @return {Model_Swytch}
    */
    Model_Swytch.prototype.withTag = function (tag) {
        Util.validateArgCount(arguments.length, 1);
    ...
    * @return {Model_Swytch}
    */
    Model_Swytch.prototype.withTags = function (tags) {
        Util.validateArgCount(arguments.length, 1);
    ...
    * @return {Model_Swytch}
    */
    Model_Swytch.prototype.withTagDnf = function (dnf) {
        Util.validateArgCount(arguments.length, 1);
