...
var Model_Bridge = require('./models/Model_Bridge');
var Model_Ipv6Net = require('./models/Model_Ipv6Net');
var Model_Script = require('./models/Model_Script');
var Model_License = require('./models/Model_License');
...
var API = (function () {
    ...
    * @return {Facility}
    */
    API.prototype.get_facility = function () {
        return this._facility;
    };

    Object.defineProperty(API.prototype, "facility", {
        /**
    ...
    * @return {Model_Bridge}
    */
    API.prototype.get_bridge = function () {
        return this._bridge;
    };

    Object.defineProperty(API.prototype, "bridge", {
        /**
        * ブリッジにアクセスするためのモデル。
        *
        * @property bridge
    ...
    */
    API.prototype.get_license = function () {
        return this._license;
    };

    Object.defineProperty(API.prototype, "license", {
        /**
        * ライセンスにアクセスするためのモデル。
        *
        * @property license
