...
var ServerActivity = require('./ServerActivity');
...
var Server = (function (_super) {
    ...
    */
    Server.prototype.get_activity = function () {
        return this._activity;
    };

    Object.defineProperty(Server.prototype, "activity", {
        /**
        * アクティビティ
        *
        * @property activity
    ...
    * @return {void}
    */
    Server.prototype._onAfterApiDeserialize = function (r, root) {
        Util.validateArgCount(arguments.length, 2);
        if (r != null) {
    ...
    * @return {boolean}
    */
    Server.prototype.sleepUntilUp = function (timeoutSec) {
    ...
    */
    Server.prototype.findDisks = function () {
        var model = Util.createClassInstance("saklient.cloud.models.Model_Disk", [this._client]);
    ...
    */
    Server.prototype.addIface = function () {
        var model = Util.createClassInstance("saklient.cloud.models.Model_Iface", [this._client]);
