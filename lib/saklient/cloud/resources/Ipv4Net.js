...
var Ipv4Range = require('./Ipv4Range');
...
var Ipv4Net = (function (_super) {
    ...
    * @return {Ipv4Range}
    */
    Ipv4Net.prototype.get_range = function () {
        return this._range;
    };

    Object.defineProperty(Ipv4Net.prototype, "range", {
        /**
        * 利用可能なIPアドレス範囲
        *
        * @property range
    ...
    * @return {void}
    */
    Ipv4Net.prototype._onAfterApiDeserialize = function (r, root) {
        Util.validateArgCount(arguments.length, 2);
        this._range = null;
        var addresses = r["IPAddresses"];
        if (addresses != null) {
