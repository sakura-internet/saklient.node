...
var Archive = (function (_super) {
        ...
        if (r != null) {
            ...
            if (("SourceDisk" in r)) {
                ...
                if (s != null) {
                    var id = s["ID"];
                    if (id != null) {
                        var obj = Util.createClassInstance("saklient.cloud.resources.Disk", [this._client, s, false]);
                        this._source = (obj);
                    }
                    ;
                }
    ...
    * @return {number}
    */
    Archive.prototype.get_displayOrder = function () {
    ...
    * @return {number}
    */
    Archive.prototype.set_displayOrder = function (v) {
        Util.validateArgCount(arguments.length, 1);
    ...
    Object.defineProperty(Archive.prototype, "displayOrder", {
        /**
        * 表示順序
        *
