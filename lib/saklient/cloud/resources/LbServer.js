...
var LbServer = (function () {
    ...
    */
    function LbServer(obj) {
        ...
        var enabled = Util.getByPathAny([obj], ["Enabled", "enabled"]);
        this._enabled = null;
        if (enabled != null) {
    ...
    * @return {boolean}
    */
    LbServer.prototype.get_enabled = function () {
    ...
    * @return {boolean}
    */
    LbServer.prototype.set_enabled = function (v) {
    ...
    Object.defineProperty(LbServer.prototype, "enabled", {
        /**
        * 有効状態
        *
        * @property enabled
